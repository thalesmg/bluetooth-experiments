...
use bindings::{
    ...
    hci_read_inquiry_scan_type, hci_read_local_name, hci_read_remote_name, hci_request,
    hci_send_req, hci_write_class_of_dev, hci_write_inquiry_mode, hci_write_inquiry_scan_type,
    hci_write_local_name, inquiry_info, IREQ_CACHE_FLUSH, OCF_READ_PAGE_SCAN_TYPE,
    OCF_WRITE_PAGE_SCAN_TYPE, OCF_WRITE_SCAN_ENABLE, OGF_HOST_CTL,
};
